...
traumatest.stats = summarise_at(
  .tbl = group_by(
    .data = traumatest,
    Group),
  .funs = list(mean=~mean(.), sem=~sd(.)/sqrt(n()), count=~n()),
...
#Plot colors
p.scale.colour = c("white","thistle4",'paleturquoise4',"#26466D","red4")
p.scale.fill = c("white","thistle4",'paleturquoise4',"#26466D","red4")
#p.scale.colour = c("white","darkgray",'darkgreen',"royalblue4","red2")
#p.scale.fill = c("white","darkgray",'darkgreen',"red","steelblue4",'darkgreen')
...
#comparison of trauma animals' freezing post shock 1
trauma.fz.ps1.anova = ezANOVA(
  data = trauma.freezing[
    trauma.freezing$Group!='NT: veh' & trauma.freezing$component=='postshock01',
    ],
  dv = freezing,
  wid = Animal,
  white.adjust = TRUE,
...
trauma.fz.ps10.anova = ezANOVA(
  data = trauma.freezing[
    trauma.freezing$Group!='NT: veh' & trauma.freezing$component=='postshock10',
    ],
  dv = freezing,
  wid = Animal,
  white.adjust = TRUE,
