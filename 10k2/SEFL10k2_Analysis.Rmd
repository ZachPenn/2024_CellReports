...
#Plot colors
p.scale.colour = c("red","steelblue4")
p.scale.fill = c("red","steelblue4")
...
P.OF.dist  +
  ...
  ggtitle("Open Field") + ylab("Distance Travelled (in)") + xlab("") +
  p.basetheme +
  theme(
...
P.OF.cnt  +
  ...
  ggtitle("Open Field") + ylab("Distance From Center (in)") + xlab("") +
  p.basetheme +
  theme(
   axis.text.x = element_text(angle=-90, hjust=0)
  )
...
P.EPM.dist  +
  ...
  ggtitle("EPM") + ylab("Distance Travelled (in)") + xlab("") +
  p.basetheme +
  theme(
   axis.text.x = element_text(angle=-90, hjust=0)
  )
...
P.EPM.cls  +
  ...
  ggtitle("EPM") + ylab("% Time in Closed Arms") + xlab("") +
  p.basetheme +
  theme(
   axis.text.x = element_text(angle=-90, hjust=0)
  )
...
P.LD.dist  +
  ...
  ggtitle("Light-Dark") + ylab("Distance Travelled (in)") + xlab("") +
  p.basetheme +
  theme(
   axis.text.x = element_text(angle=-90, hjust=0)
  )
