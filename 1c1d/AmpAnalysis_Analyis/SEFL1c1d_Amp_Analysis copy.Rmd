...
#p.margin
p.margin1 =unit(c(2, 3.3, 2, 3.3), "cm")
p.margin2 = unit(c(2, 3., 2.45, 3.), "cm") #for trauma
...
P.NS.baseline = ggplot(
  data = novstressor.prepost.bysex.stats[novstressor.prepost.bysex.stats$component=='bl',],
  aes(x=Sex,
      y=freezing_mean,
      fill=Group,
      group=Group)
